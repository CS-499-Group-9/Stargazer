...
{
    /// <summary>
    /// Used to display the degree values on the gridliens
    /// </summary>
    public partial class GridLabel : Control
    {
        ...
        /// <summary>
        /// Calculates the values and positions of the labels on during each frame.
        /// </summary>
        ...
        /// <summary>
        /// Used to pass the <see cref="Camera3D"/> from the <see cref="SkyView"/>
        /// </summary>
        ...
        /// <summary>
        /// Used to subscribe to the <see cref="ControlContainer.AzimuthToggled"/> notification. 
        /// </summary>
